          ...
          <View>
            <View style={PaymentStyle.MinViewSigninScreen}>
              <TouchableOpacity style={PaymentStyle.Imagecebter}>
                <Image source={images.Pymentsuceeful_img} resizeMode='center' style={PaymentStyle.PaymentSuccesfullImg} />
              </TouchableOpacity>
              <View style={PaymentStyle.TextCenterView}>
                <Text style={[PaymentStyle.TextCenterPayment, { color: colorrdata }]}>{t("PAYMENT_SUCCESSFULL")}</Text>
              </View>
